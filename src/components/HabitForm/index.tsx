...
const HabitForm = observer(
  ({ habitId, onDone }: { habitId: string | null; onDone: () => void }) => {
    const {
      tempHabit,
      rejectTempHabit,
      insertTempHabit,
        ...
        <div className={styles.modal}>
          ...
          >
            ...
            <div className={styles.actions}>
              <span className={styles.add} onClick={onSave}>
                <CheckboxIcon /> Сохранить
              </span>
              <div className={styles.separator} />
              <span className={styles.reject} onClick={rejectTempHabit}>
                <TimesIcon />
              </span>
              {habitId !== null && (
          ...
          <div className={styles.modalPart}>
            ...
            <div className={styles.group}>
              ...
              <div className={styles.periods}>
                <div
                  ...
                  onClick={() => tempHabit.setType("daily")}
                >
                  Ежедневно
                </div>
                <div
                  ...
                  onClick={() => tempHabit.setType("weekly")}
                >
                  Еженедельно
                </div>
                <div
                  ...
                  onClick={() => tempHabit.setType("monthly")}
                >
                  Ежемесячно
                </div>
                <div
                  ...
                  onClick={() => tempHabit.setType("custom")}
                >
                  Свой период
                </div>
              </div>
            ...
            <div className={styles.group}>
              <div className={styles.repeatDetails}>
                  ...
                  <React.Fragment>
                    <div className={styles.info}>
                      ...
                      <div className={styles.description}>
                        Выберите числа и задача будет добавляться на заданные
                      ...
                      <div className={styles.week}>
                        {range(0, 7).map(i => (
                          <div
                            className={classNames({
                              [styles.block]: true,
                              [styles.active]: tempHabit.monthlyDays.includes(
                                i + 1,
                              ),
                            })}
                ...
                {tempHabit.type === "weekly" && (
                  <React.Fragment>
                    <div className={styles.info}>
                      <div className={styles.title}>Выберите дни недели</div>
                    </div>
                    <div>
                      <div className={styles.week}>
                        {weekdays.map((day, index) => (
                          <div
                            className={classNames({
                              [styles.block]: true,
                              [styles.active]: tempHabit.weeklyDays.includes(
                                index + 1,
                              ),
                            })}
                            key={day}
                            onClick={() => tempHabit.toggleWeeklyDay(index + 1)}
                          >
                            {day}
                          </div>
                        ))}
            ...
            <div className={styles.group}>
              ...
              <div className={styles.repeatCount}>
                ...
                <input
                  type="number"
                  value={tempHabit.recordsPerDay}
                  onChange={e =>
                    tempHabit.setRecordsPerDay(parseInt(e.target.value))
                  }
                  min={1}
                  max={10}
                />
